...
data_path = "/home/nic/personal/home-automation-pipelines/data/ynab/foxcom/raw/2023_to_dec_6.csv"
register_path = (
...
foxcom_payees = list(set(pd.read_csv(data_path)["Description"].tolist()))
...
if __name__ == "__main__":
    ...
    business_mapping = generate_mapping(known_businesses, foxcom_payees)
    print_json(
        data={
            k: v for k, v in business_mapping.items() if k not in KNOWN_MAPPING.keys()
        }
    )
    # Path("/home/nic/personal/home-automation-pipelines/home_automation_pipelines/pipelines/ynab/foxcom/foxcom_known_payees.py").write_text(json.dumps(business_mapping))
# Print the mapping
